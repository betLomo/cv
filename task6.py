...
tg.create_image_sample_text(SAMPLE_TEXT, SAMPLE_FONT, 60).save(SAMPLES_PATH + "/sample_70.bmp")
...
img_70 = get_normalized_image(u.picture_to_array(SAMPLES_PATH + "sample_70.bmp"))
...
save_hypothesis(hypothesis_70, RESULTS_PATH + '/size_70/hypothesis.csv')
...
save_string(hypothesis_70, SAMPLE_TEXT_NO_SPACE, RESULTS_PATH + '/size_70/diff.csv')
